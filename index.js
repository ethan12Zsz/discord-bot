...
const chalk = require('chalk');
  ...
  console.log((chalk.cyan(`                                            #####  #    # ###### #    #  ####  #    #  #####  ###### #    # `)));
  console.log("");                                  
  console.log((chalk.yellow(`                                                               Crée par test#7926 !`)));  
  console.log((chalk.yellow(`                                                                © 2020 test, Inc.`))); 
  console.log("");                                   
  console.log((chalk.red(`                                                         Discord: test`)));   
  console.log((chalk.red(`                                                       Twitter: test`)));   
  console.log((chalk.red(`                                                        Github: test`)));   
  ...
  bot.user.setActivity("!help sur E-gen");
});
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                message.channel.send(
                    "Vous avez un temps de récupération de 1 heure ! - " +
                    message.author.tag
                );
            } else {
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    timestamp: new Date(),
                                    footer: {
                                        text: "Développé par nexrox#8284"
                                    },
                                    image: {
                                        url:
                                            ""
                                ...
                                }, 3600000); // 86400000 = 24 H , 3600000 = 1 heure
                                if (err) {
                                    console.log(err);
                                }
                            });
